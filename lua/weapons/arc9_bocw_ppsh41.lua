...
SWEP.Description = [[Full-auto submachine gun. Faster fire rate with a large bullet spread. Reliable damage range with less control when firing.

The PPSh-41 is a submachine gun featured in all the World War II-based Call of Duty games that have a Soviet campaign, as well as many games of the Black Ops series, and Call of Duty: WWII, Call of Duty: Vanguard and Call of Duty: Mobile.

The PPSh-41 returns in Call of Duty: Black Ops Cold War. It was added as part of the Season Three update.

Prior to its introduction, the PPSh-41 made a brief appearance in the intro cinematic for Die Maschine, in the hands of Soviets entering the Projekt Endstation facility.]]

SWEP.UseHands = true

SWEP.ViewModel = "models/weapons/arc9/c_arc9_ppsh41_bocw.mdl"
SWEP.WorldModel = "models/weapons/arc9/c_arc9_ppsh41_bocw.mdl"
...
SWEP.DropMagazineModel = "models/weapons/arc9/atts/bocw_ppsh41_magazine.mdl" -- Set to a string or table to drop this magazine when reloading.
...
SWEP.ShootSound = "ARC9_BOCW.PPSh41_fire"
--SWEP.ShootSoundIndoor = "ARC9_BOCW.PPSh41_fire_int_decay"                  -- Fire indoors
SWEP.ShootSoundSilenced = "ARC9_BOCW.PPSh41_fire_silenced"                    -- Fire silenced
...
SWEP.CustomizePos = Vector(12, 38, 4)
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Bone = "tag_weapon",
        Pos = Vector(-6.9, -4.4, 6.6),
        Ang = Angle(0, 0, 0),
        Icon_Offset = Vector(20.25, 4.5, -5),
        Category = {"bocw_ppsh41_underbarrel"},
    ...
    },
    {
        PrintName = "STICKER 1",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_ppsh41_sticker1.mdl",
        CosmeticOnly = true,
    },
    {
        PrintName = "STICKER 2",
...
local CustomSlotTable = {
    ...
    Category = {"bocw_custom_slot", "bocw_custom_slot_ppsh41"},
}
...
SWEP.Hook_TranslateAnimation = function(swep, anim)
    ...
    if elements["ppsh41_mag_ext"] then
        return anim .. "_ext"
    end

    if elements["ppsh41_mag_fast"] then
        return anim .. "_fast"
    end

    if elements["ppsh41_mag_mix"] then
        return anim .. "_mix"
    end
end
...
SWEP.Animations = {
    ...
    ["ready"] = {
        Source = {"ready"},
        EventTable = {
            { s = "ARC9_BOCW.PPSh41_boltback", t = 0.4 },
            { s = "ARC9_BOCW.PPSh41_reload_end", t = 0.9 },
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = "ARC9_BOCW.PPSh41_reload_end", t = 1.6 },
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["reload_ext"] = {
        ...
        EventTable = {
            ...
            { s = "ARC9_BOCW.PPSh41_reload_ext_magin", t = 1 },
            { s = "ARC9_BOCW.PPSh41_reload_end", t = 1.7 },
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["enter_inspect"] = {
        Source = "inspect",
        EventTable = {
            { s = "ARC9_BOCW.PPSh41_inspect_part1", t = 0 },
            { s = "ARC9_BOCW.PPSh41_inspect_part2", t = 2.5 },
            { s = "ARC9_BOCW.PPSh41_inspect_part3", t = 5.8 },
        },
        IKTimeLine = {
            {
                t = 0,
