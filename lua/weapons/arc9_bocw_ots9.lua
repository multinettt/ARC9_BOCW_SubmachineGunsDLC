...
SWEP.PrintName = "OTs 9"
SWEP.TrueName = "OTs-02 Kiparis"
...
SWEP.Description = [[Full-auto submachine gun. Impressive firepower at close range with good visibility while firing. Reliable recoil control with a smaller magazine size.

The OTs-02 Kiparis is a Russian submachine gun featured in Call of Duty: Black Ops, Call of Duty: Black Ops Cold War and Call of Duty: Mobile.

The Kiparis returns in Call of Duty: Black Ops Cold War as the OTs 9. It was added as part of the Season Four Reloaded update.]]

SWEP.UseHands = true

SWEP.ViewModel = "models/weapons/arc9/c_arc9_ots9_bocw.mdl"
SWEP.WorldModel = "models/weapons/arc9/c_arc9_ots9_bocw.mdl"
...
SWEP.RangeMin = 12 * 39.37 -- How far bullets retain their maximum damage for.
...
SWEP.DropMagazineModel = "models/weapons/arc9/atts/bocw_ots9_magazine.mdl" -- Set to a string or table to drop this magazine when reloading.
...
SWEP.ShootSound = "ARC9_BOCW.OTs9_fire"
--SWEP.ShootSoundIndoor = "ARC9_BOCW.OTs9_fire_int_decay"                  -- Fire indoors
SWEP.ShootSoundSilenced = "ARC9_BOCW.OTs9_fire_silenced"                    -- Fire silenced
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Ang = Angle(0, 0, 0),
        Icon_Offset = Vector(0, 0, 0),
        Category = {"bocw_ots9_barrel"},
        InstalledElements = {"barrelgone"},
    },
    {
        PrintName = "BODY",
        Bone = "tag_barrel",
        Pos = Vector(-0.7, 1.05, 0),
        Ang = Angle(0, 0, 0),
        Icon_Offset = Vector(0, 0, 0),
    ...
    },
    {
        PrintName = "STICKER 1",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_ots9_sticker1.mdl",
        CosmeticOnly = true,
    },
    {
        PrintName = "STICKER 2",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_ots9_sticker2.mdl",
        CosmeticOnly = true,
    },
    {
        PrintName = "STICKER 3", 
...
SWEP.Hook_ModifyBodygroups = function(self, data)
    ...
    if attached["bocw_ots9_underbarrel"] or attached["bocw_smg_underbarrel_east"] then
        if attached["bocw_ots9_barrel"] then
            vm:SetBodygroup(6, 0)
        else
...
SWEP.Hook_TranslateAnimation = function(swep, anim)
    ...
    if elements["ots9_mag_fast"] then
        return anim .. "_fast"
    end
...
SWEP.Animations = {
    ...
    ["ready"] = {
        Source = {"ready"},
        EventTable = {
            { s = "ARC9_BOCW.OTs9_ready", t = 0 },
            { s = "ARC9_BOCW.OTs9_reload_end", t = 0.5 },
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["ready_nostock"] = {
        ...
        EventTable = {
            { s = "ARC9_BOCW.OTs9_boltback", t = 0.2 },
            { s = "ARC9_BOCW.OTs9_boltrelease", t = 0.3 },
            { s = "ARC9_BOCW.OTs9_reload_end", t = 0.5 },
        },
        IKTimeLine = {
            {
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = "ARC9_BOCW.OTs9_reload_magout", t = 0.3 },
    ...
    ["reload_fast"] = {
        ...
        EventTable = {
            { s = "ARC9_BOCW.OTs9_reload_start", t = 0 },
            { s = "ARC9_BOCW.OTs9_reload_magout", t = 0.6 },
            { s = "ARC9_BOCW.OTs9_reload_magin", t = 1.1 },
            { s = "ARC9_BOCW.OTs9_reload_end", t = 1.6 },
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["reload_empty_fast"] = {
        ...
        EventTable = {
            ...
            { s = "ARC9_BOCW.OTs9_reload_magout", t = 0.6 },
            { s = "ARC9_BOCW.OTs9_reload_magin", t = 1.1 },
            { s = "ARC9_BOCW.OTs9_boltback", t = 1.9 },
            { s = "ARC9_BOCW.OTs9_boltrelease", t = 2 },
            { s = "ARC9_BOCW.OTs9_reload_end", t = 2.2 },
        },
        IKTimeLine = {
            {
                t = 0,
