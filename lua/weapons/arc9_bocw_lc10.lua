...
SWEP.Description = [[Full-auto submachine gun. Well rounded with excellent damage range and good accuracy. Moderate damage with an impressive muzzle velocity and a high fire rate.

The LC10 is a submachine gun featured in Call of Duty: Black Ops Cold War, and Call of Duty: Black Ops 6.

The LC10 was added to Call of Duty: Black Ops Cold War as part of the Season Two update.]]

SWEP.UseHands = true

SWEP.ViewModel = "models/weapons/arc9/c_arc9_lc10_bocw.mdl"
SWEP.WorldModel = "models/weapons/arc9/c_arc9_lc10_bocw.mdl"
...
SWEP.RangeMax = 51 * 39.37 -- In Hammer units, how far bullets can travel before dealing DamageMin.
...
SWEP.DropMagazineModel = "models/weapons/arc9/atts/bocw_lc10_magazine.mdl" -- Set to a string or table to drop this magazine when reloading.
...
SWEP.ShootSound = "ARC9_BOCW.LC10_fire"
--SWEP.ShootSoundIndoor = "ARC9_BOCW.LC10_fire_int_decay"                  -- Fire indoors
SWEP.ShootSoundSilenced = "ARC9_BOCW.LC10_fire_silenced"                    -- Fire silenced
...
SWEP.CustomizeAng = Angle(90, 3.18037, -1)
...
SWEP.Attachments = {
    {
        ...
        CorrectiveAng = Angle(-1.45, -1.45, 0),
    },
    {
        PrintName = "MUZZLE",
        Bone = "tag_muzzle",
        ...
        Ang = Angle(0, 0, 0),
        Icon_Offset = Vector(0, 0, 0),
        Category = {"bocw_lc10_muzzle", "bocw_smg_muzzle_west45"},
        Installed = "bocw_lc10_muzzle_base",
        Integral = "bocw_lc10_muzzle_base",
    },
    {
        PrintName = "BARREL",
        Bone = "tag_barrel",
        ...
        Category = {"bocw_lc10_barrel"},
        InstalledElements = {"barrelgone"},
    },
    {
        PrintName = "BODY",
        Bone = "tag_barrel",
        Pos = Vector(4.5, 0.9, 0),
        Ang = Angle(0, 0, 0),
        Icon_Offset = Vector(0, 0.3, 0),
    ...
    },
    {
        ...
        Bone = "tag_weapon",
        Pos = Vector(-11.5, -4.42, 6.2),
        Ang = Angle(0, 0, 0),
        Icon_Offset = Vector(20.25, 4.5, -5),
        Category = {"bocw_lc10_underbarrel", "bocw_smg_underbarrel_west"},
    ...
    },
    {
        PrintName = "STICKER 1",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_lc10_sticker1.mdl",
        CosmeticOnly = true,
    },
    {
        PrintName = "STICKER 2",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_lc10_sticker2.mdl",
        CosmeticOnly = true,
    },
    {
        PrintName = "STICKER 3",
...
local CustomSlotTable = {
    ...
    Category = {"bocw_custom_slot", "bocw_custom_slot_lc10"},
}
...
SWEP.Hook_TranslateAnimation = function(swep, anim)
    ...
    if elements["lc10_mag_ext"] then
        return anim .. "_ext"
    end

    if elements["lc10_mag_fast"] then
        return anim .. "_fast"
    end

    if elements["lc10_mag_mix"] then
        return anim .. "_mix"
    end
end
...
SWEP.Animations = {
    ...
    ["ready"] = {
        Source = {"ready"},
        EventTable = {
            { s = "ARC9_BOCW.LC10_draw", t = 0 },
            { s = "ARC9_BOCW.LC10_boltback", t = 0.3 },
            { s = "ARC9_BOCW.LC10_boltrelease", t = 0.5 },
            { s = "ARC9_BOCW.LC10_reload_end", t = 0.7 },
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = "ARC9_BOCW.LC10_reload_magout", t = 0.3 },
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            { s = "ARC9_BOCW.LC10_reload_magout", t = 0.7 },
            { s = "ARC9_BOCW.LC10_reload_magin", t = 1.2 },
            { s = "ARC9_BOCW.LC10_empty_rattle", t = 1.6 },
    ...
    ["reload_empty_fast"] = {
        ...
        EventTable = {
            ...
            { s = "ARC9_BOCW.LC10_reload_magout", t = 0.6 },
            { s = "ARC9_BOCW.LC10_reload_magin", t = 1.1 },
            { s = "ARC9_BOCW.LC10_boltback", t = 1.9 },
            { s = "ARC9_BOCW.LC10_boltrelease", t = 2 },
            { s = "ARC9_BOCW.LC10_reload_end", t = 2.2 },
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["enter_inspect"] = {
        Source = "inspect",
        EventTable = {
            { s = "ARC9_BOCW.LC10_inspect_part1", t = 0 },
            { s = "ARC9_BOCW.LC10_inspect_part2", t = 3.7 },
        },
        IKTimeLine = {
            {
                t = 0,
